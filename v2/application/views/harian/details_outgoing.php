<div id="content">
        ...
        <br />
    	Laporan Pendapatan Harian Outgoing Airline : <?php echo strtoupper($airline); ?>  Tanggal : <?php echo $startdate." s/d ".$enddate; ?><br />
        <table>
        ...
        <?php echo anchor('harian/outgoing_pdf/' . $airline . '/' . $startdate . '/' . $enddate . '/', 'export to pdf' ); ?>
