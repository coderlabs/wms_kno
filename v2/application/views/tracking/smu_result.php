<div id="content">
      ...
      <?php foreach($query as $item): ?>
      <tr>
      	<td><?php echo $item->inb_airlines; ?></td>
        <td><?php echo $item->inb_flight_number; ?></td>
        <td><?php echo $item->inb_update_on; ?></td>
        <td><?php #echo $item->inb_btb; ?></td>
        <td><?php echo $item->inb_no_smu; ?></td>
        <td><?php #echo $item->inb_agent; ?></td>
        <td><?php #echo $item->inb_tujuan; ?></td>
        <td><?php echo $item->inb_koli; ?></td>
        <td><?php echo $item->inb_berat_aktual; ?></td>
