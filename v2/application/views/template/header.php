...
<meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/wms/css/bootstrap.css">
   ...
   <script src="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/wms/js/bootstrap.js" type="text/javascript"></script>
   <script src="<?php echo base_url(); ?>wp-content/themes/gapura-angkasa/wms/js/dropdown.js" type="text/javascript"></script>
